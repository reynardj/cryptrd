<?php if (empty($points->reward_amount)) { ?>
    <div class="email" style="max-width: 500px;">
        <div style="color:black; text-align:left;">
            ...
            <br>ID Member <strong><?=$old_loyalty_no?></strong> kamu di <strong><?=$brand_name?></strong> telah
            berhasil dimigrasi ke sistem GET DISKON.
...
<?php } else if (!empty($points->reward_amount)) { ?>
    <div class="email" style="max-width: 500px;">
        <div style="color:black; text-align:left;">
            <br>Hai <strong>sobat Get Diskon</strong>,
            <br>ID Member <strong><?=$old_loyalty_no?></strong> kamu di <strong><?=$brand_name?></strong>
             telah berhasil dimigrasi ke sistem GET DISKON. Kamu mendapatkan reward:
            <br><br>
