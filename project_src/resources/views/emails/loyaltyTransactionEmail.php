<?php if (empty($points->reward_amount)) { ?>
    <div class="email" style="max-width: 500px;">
        <div style="color:black; text-align:left;">
            ...
            <br>Kamu telah berbelanja di <strong><?=$brand_name?></strong>. Segera lakukan registrasi melalui link
            berikut ini dan dapatkan berbagai promo menarik.
...
<?php } else if (!empty($points->reward_amount)) { ?>
    <div class="email" style="max-width: 500px;">
        <div style="color:black; text-align:left;">
            <br>Hai <strong>sobat Get Diskon</strong>,
            <br>Kamu telah berbelanja di <strong><?=$brand_name?></strong> dan mendapatkan reward:
            <br><br>
