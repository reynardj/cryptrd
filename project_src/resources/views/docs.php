...
<head>
  <meta charset="UTF-8">
  <title>Get Diskon API Docs</title>
...
<script src="<?=$base_url?>/assets/swagger-ui-bundle.js"> </script>
<script src="<?=$base_url?>/assets/swagger-ui-standalone-preset.js"> </script>
<script>
